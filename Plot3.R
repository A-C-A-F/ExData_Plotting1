...
plot3 <- strptime(paste(hpc_subset$Date, hpc_subset$Time, sep=" "), "%d/%m/%Y %H:%M:%S") 
...
plot(plot3, subMeter1, type="l", ylab="Energy Submetering", xlab="")
lines(plot3, subMeter2, type="l", col="red")
lines(plot3, subMeter3, type="l", col="blue")
